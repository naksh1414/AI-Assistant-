...
class MainThread(QThread):
      ...
      def TaskExecution(self) :
             ...
             while True :
                  ...
                  elif "play songs on YouTube" in self.query or "songs" in self.query :
                        k.playonyt("night changes")
                  ...
                  elif 'no thank you' in self.query or "no" in self.query or "stop" in self.query :
                  ...
                  elif "how are you ?" in self.query or "how you doing?" in self.query or "whats up" in self.query:
                  ...
                  elif "speed test" in self.query or "speed" in self.query or "internet speed" in self.query :
...
class Main(QMainWindow):
      ...
      def startTask (self):
            self.ui.movie = QtGui.QMovie("D:/arc_reactor__iron_man__wallpaper_by_little_space_ace_d656jfy.png") 
